...
## Verification
Run cargo test/check, cargo fmt --check, Dioxus web build, and `bun crates/shprd-shell/tests/browser.mjs` against built assets. Android requires real SDK, NDK and Rust target; browser width is not Android proof.
