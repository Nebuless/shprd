...
- Iframe fills `100dvh`. Before connection, Dioxus renders a narrow, accessible remote-host form; after connection, React owns visible settings inside the iframe.
- Dioxus and React host controls have visible labels, 44px minimum touch buttons, focus ring, pending state, live status and error state.
