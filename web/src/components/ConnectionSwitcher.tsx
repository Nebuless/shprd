  ...
  return (
    ...
    >
      ...
      <label className="connection-profile-checkbox">
        ...
        />
        Connect automatically when SHPRD starts
      </label>
...
function SshProfileForm({
  ...
  return (
    ...
    >
      ...
      <p className="connection-profile-security-note">
        Leave the socket paths empty and SHPRD infers the default Herdr sockets
        under the remote home directory at connect time. Authentication comes
        from the bridge service user&apos;s OpenSSH config, ssh-agent, or system
        Keychain. Establish host trust outside SHPRD. Passwords, keys,
    ...
    <div className="modal-backdrop" onMouseDown={pending ? undefined : onClose}>
      ...
      >
        ...
        <ConfirmDialog
          ...
          message={
            removeTarget
              ? `Remove connection "${removeTarget.label}"? This disconnects SHPRD but does not stop the Herdr server.`
